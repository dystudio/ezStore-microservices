...
namespace Ws4vn.Microservices.ApplicationCore.Interfaces
{
    public interface IDataAccessReadOnlyRepository<TModel> : IDisposable where TModel : class
    {
        ...
        Task<PagedResult<TModel>> GetPagedAsync(Expression<Func<TModel, bool>> filter = null,
            string orderBy = null, bool orderAsc = true,
            string includeProperties = "", bool isIncludedIsDeleted = true,
            int page = 1, int pageSize = 20);
        ...
        Task<PagedResult<TModel>> GetPagedAsync(Expression<Func<TModel, bool>> filter,
            Func<IQueryable<TModel>, IOrderedQueryable<TModel>> orderBy,
            string includeProperties = "", bool isIncludedIsDeleted = true,
            int page = 1, int pageSize = 20);
        ...
        Task<TModel> FirstOrDefaultAsync(Expression<Func<TModel, bool>> filter = null,
            Func<IQueryable<TModel>, IOrderedQueryable<TModel>> orderBy = null,
            string includeProperties = "", bool isIncludedIsDeleted = true);
    }
}